...
import com.ezijing.qa.message.GetThreadId;
 ...
 *
 */
public class GetPurchase extends TestBase{

	static Logger logger = Logger.getLogger(GetPurchase.class);
	...
	public void getPurchaseNormal() {
		...
		JSONObject json = coursebo.coursePurchase(headers, params);
