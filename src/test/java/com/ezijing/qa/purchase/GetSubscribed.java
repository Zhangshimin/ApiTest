 ...
 *
 */
public class GetSubscribed extends TestBase{
	...
	@Test
	public void getSubscribedNormal() {
		logger.info("Test Case is : getSubscribedNormal");
		JSONObject json = coursebo.courseGetSubscribed(headers, params);
