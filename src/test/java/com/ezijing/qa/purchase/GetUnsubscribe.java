 ...
 *
 */
public class GetUnsubscribe extends TestBase{

	static Logger logger = Logger.getLogger(GetUnsubscribe.class);
	...
	@Test
	public void getUnsubscribeNormal() {
		logger.info("Test Case is : getUnsubscribeNormal");
		JSONObject json = coursebo.courseUnsubscribe(headers, params,nodeid);
