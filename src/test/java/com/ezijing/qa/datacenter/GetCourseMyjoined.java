...
import com.ezijing.qa.datacenter.video.GetVideoProgress;
import com.ezijing.qa.util.BaseApiUtil;
import com.ezijing.qa.util.Utils;
import com.ezijing.qa.vo.ResponseVo;
import com.ezijing.qa.vo.RequestVo;

public class GetCourseMyjoined extends TestBase{
	static Logger logger = Logger.getLogger(GetCourseMyjoined.class);
	...
	@Test
	public void courseMyJoined() {
		params.clear();
		params.put("course_ids", "940");
		JSONObject json = coursebo.courseMyJoined(headers, params);
