...
public class PostBookUnmarks extends TestBase{
	static Logger logger = Logger.getLogger(PostBookUnmarks.class);
	...
	public void bookmarks()
	{
		params.clear();
		params.put("js", "TRUE");
		requestvo.setRequestVo(headers,params,"http://sit.ezijing.com/flag/unflag/bookmarks/940");
		JSONObject json = BaseApiUtil.getResponse(requestvo);
		assertEquals(json.getString("flagStatus"),"unflagged");
	}
	@AfterMethod
