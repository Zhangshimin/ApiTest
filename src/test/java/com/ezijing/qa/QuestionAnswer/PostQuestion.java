...
public class PostQuestion extends TestBase{
	static Logger logger = Logger.getLogger(PostQuestion.class);
	...
	@Test
	  public void createQuestionNormal() {
		logger.info("Test Case is : createQuestionNormal");
		params = PoiUtils.getTestData(EXCEL_WEB_FILE, "Question", "PostQuestion");
		JSONObject json = questionbo.createQuestion(headers, params);
