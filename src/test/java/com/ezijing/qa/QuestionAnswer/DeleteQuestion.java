...
public class DeleteQuestion extends TestBase{
	...
	@Test
	public void deleteQuestionNormal() {
		logger.info("Test Case is : deleteQuestionNormal");
		JSONObject json = questionbo.deleteQuestion(headers, params, questionid);
