...
import com.ezijing.qa.datacenter.GetIsLogin;
import com.ezijing.qa.util.BaseApiUtil;
import com.ezijing.qa.util.PoiUtils;
import com.ezijing.qa.vo.RequestVo;

public class DeleteQaAnswer extends TestBase{

	static Logger logger = Logger.getLogger(DeleteQaAnswer.class);
	...
	@Test
	  public void deleteAnswerNoraml() {
		logger.info("Test Case is : createAnswerNormal");
		JSONObject json = answerbo.deleteAnswer(headers, params, answerid);
	  }
	@AfterMethod
