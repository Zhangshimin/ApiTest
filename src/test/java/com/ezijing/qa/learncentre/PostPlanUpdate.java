 ...
 *
 */
public class PostPlanUpdate extends TestBase{
	static Logger logger = Logger.getLogger(PostPlanUpdate.class);
	...
	public void updatePlan() {
		...
		params = PoiUtils.getTestData(EXCEL_DATA_FILE, "LearnCenter","PostPlanUpdate");
		params.put("package_id", packageID.toString());
		params.put("started_at", Utils.dataNow());
		JSONObject json = learnbo.updatePlan(headers, params);
