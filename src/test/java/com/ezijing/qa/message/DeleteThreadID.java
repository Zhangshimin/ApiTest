...
public class DeleteThreadID extends TestBase{
	
	static Logger logger = Logger.getLogger(GetThreadId.class);
	...
	@Test
	public void delThreadIdNormal() {
		logger.info("Test Case is : getThreadIdNormal");
		JSONObject json = messagebo.deleteThreadId(headers, params, threadid);
